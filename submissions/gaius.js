...
const name = 'gaius'; // replace with your actual name here too
// Task 1
...
// --------------------------------------------------------------------------------------------
function testSubject(n) {
    return `${n} is being tested`;
};
...
function doubleSum(num1, num2) {
    let num = 0;
    num += multiplyByTwo(num1);
    num += multiplyByTwo(num2);
    return num;
};
...
function countWords(string) {
    ...
    let returnWord = `${longest}:${longest.split(" ").length}`;
    return returnWord;
};
