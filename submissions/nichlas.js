...
const name = 'Nichlas'; // replace with your actual name here too
// Task 1
...
function decapitalizer(...args) {
    return args.filter(arg => typeof arg === "string").map(str => str.toLowerCase()).join(`=`);
}
